                ...
                <div class="p-4 sm:p-6 lg:p-8">
                    ...
                    <header class="mb-6 border-b pb-3 dark:border-gray-700">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Define el nombre, nivel de jerarquía y los permisos asociados a este nuevo rol.') }}
                        </p>
                    </header>
                    ...
                    <form method="POST" action="{{ route('admin.roles.store') }}" class="space-y-8">
                        ...
                        {{-- GRID PRINCIPAL: 2 COLUMNAS EN ESCRITORIO PARA SEPARAR DATOS BÁSICOS Y PERMISOS --}}
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="lg:col-span-1 space-y-6 bg-gray-50 dark:bg-gray-700/30 p-4 sm:p-6 rounded-lg shadow-inner">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="nombre" name="nombre" type="text" class="mt-1 block w-full" :value="old('nombre')" required autofocus autocomplete="nombre" placeholder="ej: editor_contenido" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="nivel" name="nivel" type="number" min="1" max="100" class="mt-1 block w-full" :value="old('nivel', 1)" required autocomplete="nivel" />
                                ...
                                <div>
                                    ...
                                    <textarea id="descripcion" name="descripcion" rows="4" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-fuchsia-500 dark:focus:border-fuchsia-600 focus:ring-fuchsia-500 dark:focus:ring-fuchsia-600 rounded-lg shadow-sm" autocomplete="descripcion" placeholder="Rol encargado de la gestión de artículos...">{{ old('descripcion') }}</textarea>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400 mb-6">
                                    {{ __('Marca las casillas para otorgar las capacidades específicas a este rol. Los permisos están agrupados por recurso.') }}
                                </p>

                                {{-- Contenedor de Permisos: Organizado en 3 o 4 columnas en desktop --}}
                                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-x-6 gap-y-4">
                                    ...
                                    @empty
                                        <p class="col-span-full text-sm text-yellow-600 dark:text-yellow-400">
                                            {{ __('No hay permisos registrados. Por favor, crea permisos primero.') }}
                                        </p>
                                    @endforelse
                                </div>
