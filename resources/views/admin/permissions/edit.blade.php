                ...
                <div class="p-4 sm:p-6 lg:p-8">
                    ...
                    <header class="mb-6 border-b pb-3 dark:border-gray-700">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Actualiza el nombre y la descripción del permiso.') }}
                        </p>
                    </header>
                    ...
                    <form method="POST" action="{{ route('admin.permissions.update', $permission) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="nombre" name="nombre" type="text" class="mt-1 block w-full" :value="old('nombre', $permission->nombre)" required autofocus />
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('Formato: recurso.accion (ej: posts.delete).') }}</p>
                        ...
                        <div>
                            ...
                            <textarea id="descripcion" name="descripcion" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-fuchsia-500 focus:ring-fuchsia-500 rounded-lg shadow-sm">{{ old('descripcion', $permission->descripcion) }}</textarea>
